...
private:
    ...
    // I am leaving the full S Box, because I want to be able to encrypt a file, whatever legal ASCII chars it may have
    constexpr static unsigned char S_BOX[] = {
    ...
    // Instead of doing Galois multiplication, use lookup tables
    constexpr static unsigned char MULTIPLY_2[] = {
    ...
    // Instead of doing Galois multiplication, use lookup tables
    constexpr static unsigned char MULTIPLY_3[] = {
    ...
    // In AES-128, we only ever need the first 10 values, so the rest may be deleted
    constexpr static unsigned char RCON[] = {
...
//AES STEPS
private:
    // I am writing this step on an intel mac, which is  little endian, but I am writing it as if it is big endian
