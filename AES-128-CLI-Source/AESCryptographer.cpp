...
private:
    ...
    static constexpr unsigned char MULTIPLY_2[256] = {
    ...
    static constexpr unsigned char MULTIPLY_3[256] = {
    ...
    static constexpr unsigned char MULTIPLY_9[256] = {
    ...
    static constexpr unsigned char MULTIPLY_11[256] = {
    ...
    static constexpr unsigned char MULTIPLY_13[256] = {
    ...
    static constexpr unsigned char MULTIPLY_14[256] = {
    ...
    static constexpr unsigned char S_BOX[256] = {
    ...
    static constexpr unsigned char INV_S_BOX[256] = {
...
private:
    static void encryptBlock(unsigned char *message, unsigned char *key) {
    ...
    static void decryptBlock(unsigned char *cipherText, unsigned char *key) {
        unsigned char state[BLOCK_SIZE];
        for (int i = 0; i < BLOCK_SIZE; ++i) {
...
public:
    static void encrypt(std::ifstream &src,
        ...
        // WARNING!!!
        // Comment this out when testing if you want to compare result to online AES tools
